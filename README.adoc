...
* https://www.youtube.com/watch?v=HZkqMiwT-5A[Reactive Programming with Swift: 이선협님 영상]
* https://www.slideshare.net/sunhyouplee/reactive-programming-with-swift[Reactive Programming with Swift: 이선협님 발표 자료]

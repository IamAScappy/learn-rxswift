...
struct TimelineEvent  {
  ...
  static func Next(_ text: String) -> TimelineEvent {
    return TimelineEvent(.next(text))
  }
  
  static func Next(_ value: Int) -> TimelineEvent {
    return TimelineEvent(.next(String(value)))
  }
  
  static func Completed(_ keepRunning: Bool = false) -> TimelineEvent {
    return TimelineEvent(.completed(keepRunning))
  }
  
  static func Error() -> TimelineEvent {

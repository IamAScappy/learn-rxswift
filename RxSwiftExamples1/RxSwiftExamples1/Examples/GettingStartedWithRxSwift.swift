//
//  GettingStartedWithRxSwift.swift
//  RxSwiftExample
//
...
class GettingStartedWithRxSwift: UIViewController {
...
extension GettingStartedWithRxSwift {
...
// MARK: - Subcribing To Observables

extension GettingStartedWithRxSwift {
  
  func subscribeToObservables() {
    let observable = Observable.of(woong, gamja, sj)
